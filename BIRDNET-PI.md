<!--
  This is the technical README for the BirdNET-Pi engine that powers this fork.
  For the personal "little-visitors" bird tracking station project, see README.md
-->
> ℹ️ This is the technical documentation for the **BirdNET-Pi engine** that powers this fork.
> For the **little-visitors** bird tracking station project this repository hosts, see [README.md](README.md).
